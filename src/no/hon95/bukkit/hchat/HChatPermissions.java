...
public final class HChatPermissions {
	...
	public static final String PERM_COMMAND_AWAY = "hchat.command.away";
	...
	public static final String PERM_COMMAND_CHANNEL_EDIT_AUTO_JOIN_IF_DEFAULT = "hchat.command.channel.edit.autojoinifdefault";
	public static final String PERM_COMMAND_CHANNEL_EDIT_RANGE = "hchat.command.channel.edit.range";
	public static final String PERM_COMMAND_CHANNEL_EDIT_MONITOR_CHANNELS = "hchat.command.channel.edit.monitorchannels";
	public static final String PERM_COMMAND_CHANNEL_EDIT_MEMBER_GROUPS = "hchat.command.channel.edit.membergroups";
